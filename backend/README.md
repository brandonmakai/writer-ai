...
| POST   | `/api/v1/rewrite/outline` | Refactor chapter from outline; body: `chapter_text`, `bullets` (3–8); returns refactored chapter, internal structure, change highlights. |
